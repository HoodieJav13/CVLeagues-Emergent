...
- **Surface:** `m28` — Migration 28 (Sequence 5A overtime and paired-stat rules)
- **Expected census:** 28 migrations · 26 tables · 25 admin RPCs
- **Observed hosted ledger:** 28 migrations applied, latest `20260723154411` — verified against the local sequence before baseline capture
- **Fixture game shape:** `legacy` (no venue; venues not yet published)
- **Run namespace:** `cvf-matrix-2026-07-28-aff6fd59`
- **Executed:** 2026-07-28T21:56:36.949Z to 2026-07-28T21:57:16.992Z
