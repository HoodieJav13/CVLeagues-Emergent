...
- **Run namespace:** `cvf-matrix-2026-07-17-2d272b66`
- **Executed:** 2026-07-17T17:27:03.596Z to 2026-07-17T17:27:55.008Z
- **Browser/API checks:** 146 passed, 4 failed
...
| playoff RPC success | administrator generates a fixed single-elimination bracket | FAIL | Request failed: Every active league team must appear exactly once in the seed list. |
| playoff RPC success | administrator schedules a ready bracket match | FAIL | No ready playoff match was generated. |
| playoff RPC success | administrator links a matching existing playoff game | FAIL | No second ready playoff match was available. |
| playoff RPC success | administrator advances a final locked playoff result | FAIL | Scheduled playoff game was unavailable. |
