# Hosted authorization matrix evidence — 2026-07-22

- **Overall:** PASS
- **Project:** `orlhqewzprjadyrdrqxw`
- **Run namespace:** `cvf-matrix-2026-07-22-02112fb9`
- **Executed:** 2026-07-22T04:00:42.366Z to 2026-07-22T04:01:27.813Z
- **Browser/API checks:** 218 passed, 0 failed
- **Server catalog checks:** 7 passed, 0 failed
- **Combined checks:** 225 passed, 0 failed
