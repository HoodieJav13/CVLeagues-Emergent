...
The project is linked and all twenty-seven migrations are applied with migration history, structural catalog checks, the operational row/settings baseline, and both advisors read back. Authorization acceptance is current at Migration 27's 256/256 run across the 25-RPC surface. See [`evidence/hosted-auth-matrix-2026-07-22-m27.md`](evidence/hosted-auth-matrix-2026-07-22-m27.md), [`evidence/sequence-4-hosted-push-2026-07-22.md`](evidence/sequence-4-hosted-push-2026-07-22.md), and the immutable earlier checkpoints.
