...
| **RESOLVED AND STRUCTURALLY PUBLISHED IN SEQUENCE 4; BEHAVIORAL/PILOT GATES OPEN** | Migrations 25–27 add AAL2 session/event/finalization RPCs, rotating leases, exact replay, a deterministic projection, metadata-only failure audit, public-final-only publication, W/L-only forfeits, and the single bracket-safe ledger correction authority. The 294-assertion harness, real two-connection append race, and hosted structural/catalog/advisor readbacks pass. The real-session matrix and durable pilot are not yet accepted. | `INV-01`–`INV-06`, `INV-08`–`INV-30`, `INV-32`–`INV-39` |
