...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center text-center py-20 px-6 animate-fade-up" data-testid="not-found">
      ...
      <h1 className="font-display font-extrabold uppercase tracking-tighter text-3xl md:text-4xl text-white mt-1">
        Page Not Found
      </h1>
      ...
      <Link
        ...
        className="mt-6 bg-primary text-primary-foreground font-bold uppercase tracking-wide text-sm px-6 py-3 rounded-xl hover:bg-[#06b6d4] transition-colors"
      >
        Back Home
      </Link>
    </div>
