  ...
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      <CaretDown
        size={16}
        weight="bold"
        className="shrink-0 text-muted-foreground transition-transform duration-cvf-fast ease-cvf-out motion-reduce:!transform-none motion-reduce:transition-none" />
    </AccordionPrimitive.Trigger>
