 ...
 * ========================================================================== */
const META = {
  verified: { Icon: ShieldCheck, color: "var(--cvf-teal)", label: "Eligible — waiver verified" },
  not_verified: { Icon: ShieldWarning, color: "var(--cvf-gold)", label: "Waiver not verified" },
};
