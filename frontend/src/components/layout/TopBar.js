...
export const TopBar = () => {
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#0F1416]/90 backdrop-blur-md border-b border-border">
        ...
        <nav className="hidden md:flex items-center gap-1">
          {items.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `relative px-3 py-2 rounded-lg text-sm font-bold uppercase tracking-widest transition-all duration-200 ${
                  isActive
