...
## Current Priority
Reactivation stage R1 closed at `cbfdcc6`. The active work is **R2: staged local reconciliation of the player-experience branch** (`claude/sports-league-improvements-esu4eb`) with `main`, one owner-approved stage at a time. All four stages are complete: R2-A (derived stats, participation-aware selectors, standings form/streak/tie ranks, full public profile), R2-B (Migration 29 venues/`starts_at`/participation plus its frontend cutover), R2-C (admin venue management, expanded authorization matrix, franchise history and remembered filters), and R2-D (iCalendar export, reminders, and the subscribable feed). The player-experience branch is fully integrated; nothing remains unmerged on it. Every hosted action — including publishing Migration 28 or 29 — remains separately gated. See [`docs/reconciliation/PLAYER_EXPERIENCE_INTEGRATION_2026-07-26.md`](docs/reconciliation/PLAYER_EXPERIENCE_INTEGRATION_2026-07-26.md) and [`docs/scoring/REACTIVATION_DECISION_2026-07-25.md`](docs/scoring/REACTIVATION_DECISION_2026-07-25.md). Attorney-approved New Mexico waiver text remains an independent launch blocker.
...
- Select the next stage. Migration 28 and 29 publication/acceptance, signed rushing-yard plus practice-mode completion, the durable pilot, Sequence 6, and later UI work remain separate choices; R2 authorizes none of them.
...
9e. ✅ Player-experience reconciliation (R2) — staged local integration of `claude/sports-league-improvements-esu4eb`, complete across four separately approved stages at 340/340 database assertions plus concurrency, 208/208 frontend tests across 38 suites, 21/21 API tests, and a passing production build. The branch is fully integrated. No hosted action taken; Migrations 28 and 29 remain unpublished.
