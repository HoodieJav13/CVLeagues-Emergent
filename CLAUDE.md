...
- Complete the real administrator's recovery and session-revocation acceptance. **Break-glass administrator: decided YES (2026-08-05)** — create the second TOTP-enrolled account with offline-stored credentials during that same session.
