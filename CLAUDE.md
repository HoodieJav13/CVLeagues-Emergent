...
- **Confirm both advisors clean on the Supabase dashboard** — the one step-17 readback item not reachable from the CLI. If either flags on the practice objects, the finding joins the push evidence before step 18 is approved.
