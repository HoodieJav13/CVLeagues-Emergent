...
- **Recovery/session-revocation acceptance: scheduled as the next working session, before Season 1 data entry (decided 2026-08-06).** One sitting covers the recovery test, creating the break-glass administrator (decided YES 2026-08-05, credentials stored offline), and flipping the leaked-password toggle.
